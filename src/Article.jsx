...
function Article({ image, writer, date, headline, summary}) {
    ...
    return (
        <div className="overflow-hidden p-1" style={{ height: "450px", opacity: "0%", backgroundColor: "rgba(255, 255, 255, 0.512)"}} ref={container}>
            <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}
                ...
                <div className="article-details z-1 col position-absolute w-100 left-0 bottom-0 px-4 pt-4" style={{ height: size === "small" ? "40%" : "60%" }}>
                    <div style={{ height: "95%", overflow: "hidden", whiteSpace: "no-wrap", textOverflow: "ellipsis" }} ref={articleDetails}>
                        <div ref={articleText}
                            style={{
                                transform: isHovered ? `translateY(-${articleText.current.scrollHeight - articleDetails.current.clientHeight + 10}px)` : "translateY(0)",
                ...
                <div className="w-100 position-relative" style={{ height: size === "small" ? "60%" : "40%" }}>
                    <img src={image != "" && image != undefined ? image : "/assets/no_image.png"} className="article-image"></img>
                </div>
