...
function Covid19() {
    const [object, setObject] = useState(<Articles step={8} virus="tuberculosis"></Articles>);
                ...
                <section id="#top">
                    <nav className="z-3 w-100 row navbar navbar-expand-lg  pt-4 pb-0 px-md-0 px-lg-0 mx-0" data-bs-theme="light">
                        <div className="container-fluid d-flex justify-content-even px-5">
                            ...
                            <Link className="navbar-brand" to="/covid19"> <h2><b>Tuberculosis</b></h2></Link>
                        </div>
                    </nav>
                </section>
                <div className="col d-flex justify-content-center p-5">
                    <div className="tab-container">
                        <input type="radio" name="tab" onChange={() => setObject(() => <Articles step={8} virus="tuberculosis"></Articles>)}  id="tab1" className="tab tab--1" />
